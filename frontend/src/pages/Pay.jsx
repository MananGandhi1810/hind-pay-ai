...
//   const [isLoading, setIsLoading] = useState(false);
  ...
  // Track direction of animation and initialize showTrends based on paymentType
    ...
    useEffect(() => {
        ...
        if (showTrends) {
            enablePayTimeout = setTimeout(() => {
                setEnablePay(true);
            }, 2000); // Enable pay after 2 seconds
        }
  ...
  return (
    <div className="h-full-w-nav w-screen m-auto flex items-center justify-center relative">
      <motion.div
        className="absolute  right-1/2 transform translate-x-[250px]"
        initial={{ x: 300, opacity: 0 }}
        animate={{ x: 150, opacity: 1 }}
        transition={{ type: "spring", stiffness: 100, delay: 0.2 }}
        style={{ display: showTrends ? "block" : "none" }}
      >
        <PaymentTrends />
      </motion.div>
      <motion.div
                              ...
                              onBlur={debounce(async () => {
                                ...
                                if (identifier) {
                                  try {
                                    ...
                                    console.error("Error in Pay.jsx:", error);
                                  }
                                }
                              }, 300)}
